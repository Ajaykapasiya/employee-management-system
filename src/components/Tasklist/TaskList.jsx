...
const TaskList = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex-shrink-0 h-full w-[310px] p-5  bg-blue-500 rounded-xl ml-6">
        <div className="flex justify-between items-center">
          <h3 className=" bg-red-600 px-3 py-1 text-sm rounded">High</h3>
          <h4 className="text-base font-mono ">20 feb 2024</h4>
        </div>
      ...
      <div className="flex-shrink-0 h-full w-[310px] p-5  bg-pink-600 rounded-xl ml-6">
        <div className="flex justify-between items-center">
          <h3 className=" bg-red-600 px-3 py-1 text-sm rounded">High</h3>
          <h4 className=" text-base font-mono ">20 feb 2024</h4>
        </div>
      ...
      <div className="flex-shrink-0 h-full w-[310px] p-5  bg-yellow-400 rounded-xl ml-6">
        <div className="flex justify-between items-center">
          <h3 className=" bg-red-600 px-3 py-1 text-sm rounded">High</h3>
          <h4 className=" text-base font-mono ">20 feb 2024</h4>
        </div>
      ...
      <div className="flex-shrink-0 h-full w-[310px] p-5  bg-red-600 rounded-xl ml-6">
        <div className="flex justify-between items-center">
          <h3 className=" bg-red-600 px-3 py-1 text-sm rounded">High</h3>
          <h4 className="text-base font-mono ">20 feb 2024</h4>
        </div>
      ...
      <div className="flex-shrink-0 h-full w-[310px] p-5  bg-blue-300 rounded-xl ml-6">
        <div className="flex justify-between items-center">
          <h3 className=" bg-red-600 px-3 py-1 text-sm rounded">High</h3>
          <h4 className=" text-base font-mono ">20 feb 2024</h4>
        </div>
